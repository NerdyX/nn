import type { CSSProperties, ClassList, JSXOutput, Signal } from '@builder.io/qwik';
 ...
 */
export type SubmitHandler<TFieldValues extends FieldValues> = (values: TFieldValues, event: SubmitEvent) => MaybePromise<any>;
/**
 ...
 */
export declare function Form<TFieldValues extends FieldValues, TResponseData extends ResponseData>({ of: form, action, onSubmit$, responseDuration: duration, keepResponse, shouldActive, shouldTouched, shouldDirty, shouldFocus, reloadDocument, children, ...formProps }: FormProps<TFieldValues, TResponseData>): JSXOutput;
