  ...
  const signTx = $(async (txjson: Record<string, unknown>) => {
    ...
    try {
      ...
      if (wallet.walletType.value === "xaman" || !wallet.walletType.value) {
        ...
        const { signWithCrossmark } =
          await import("~/components/wallets/crossmark");
              ...
              <div>
                ...
                {marketData.value && (
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div class="bg-linear-to-br from-blue-50 to-white rounded-xl p-5 border border-blue-100">
                    ...
                    <div class="bg-linear-to-br from-green-50 to-white rounded-xl p-5 border border-green-100">
                    ...
                    <div class="bg-linear-to-br from-purple-50 to-white rounded-xl p-5 border border-purple-100">
                    ...
                    <div class="bg-linear-to-br from-amber-50 to-white rounded-xl p-5 border border-amber-100">
